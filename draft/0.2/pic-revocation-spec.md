...
This document is the **PIC Revocation Specification**, a subordinate specification of the [PIC Specification](https://github.com/pic-protocol/pic-spec/blob/main/draft/0.2/pic-spec.md). It defines how
...
[PIC Prover and Verifier Specification](https://github.com/pic-protocol/pic-spec/blob/main/draft/0.2/pic-prover-verifier-spec.md); they do not alter the PIC Model invariants — non-expansion of the
...
## Three Kinds of Revocation State
...
[PIC Prover and Verifier Specification](https://github.com/pic-protocol/pic-spec/blob/main/draft/0.2/pic-prover-verifier-spec.md) and are covered by the same single PCA signature; they do not change
...
([PIC Prover and Verifier Specification](https://github.com/pic-protocol/pic-spec/blob/main/draft/0.2/pic-prover-verifier-spec.md), Section 6.2) and carry a valid signature (or equivalent origin
...
## Verifier Hop Validation

In addition to the hop checks of the [PIC Prover and Verifier Specification](https://github.com/pic-protocol/pic-spec/blob/main/draft/0.2/pic-prover-verifier-spec.md) (Section 3.3), a
...
## Identity and Evidence Selectors
...
# Revocation Authorization and State
...
## Dynamic Restriction Requirements
...
## Revocation State and Availability
...
## Trusted Time and Key Compromise
