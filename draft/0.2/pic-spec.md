...
| [PIC Lineage Guardrail Specification](./pic-lineage-guardrail-spec.md) | A **Lineage Execution** is a single-origin PIC execution; a **Multi-Lineage Execution** carries one or more of them together for one proposed transition. **Execution Guardrails** — invoked by trusted sandboxes — validate the participating PCAs, evaluate configured policy over semantic scopes, and enforce permit or deny; permitted crossings travel in a guardrail envelope. *Participation, not authority mixing.* | Draft 0.2 | 2026-07-19 |
| [PIC Architecture and Deployment Specification](./pic-architecture-deployment-spec.md) | Reference architectures and deployment topologies for PIC systems: how Provers, Verifiers, Execution Guardrails, and sandboxes are arranged and operated. Skeleton revision — content under development. | Draft 0.1 | 2026-07-19 |
